...
func InitOptionMap() {
	...
	common.OptionMap["VideoOutputRatio"] = ratio_setting.VideoOutputRatio2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "VideoOutputRatio":
		err = ratio_setting.UpdateVideoOutputRatioByJSONString(value)
	case "AudioRatio":
